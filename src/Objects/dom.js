...
const Dom = (() => {
  ...
  function createStory() {
	...
	div.innerHTML =
    "<p>The most famous fight in <strong>Dragon Ball</strong> history took place on the planet Namek.<br> Namek is a place between Earth’s adopted 	 Saiyan Goku and the intergalactic criminal tyrant, Frieza. <br>Goku was heading towards defeat until the death of his best friend, Krillin,	  sparked the red-haired Super Saiyan transformation that would give him the power to win the battle and escape the exploding planet. 	  </br></br></br><strong><b><i><u>HOW TO PLAY:<strong></b></i></u><br>	 <strong>Use a/w/d/s to move, 'j' to launch Goku Destructo Disk, and <br> 'i' to call Picolo for aid against Beerus (God of Distruction).<br><br><strong><b><i><u>NOTE:<strong></b></i></u>	</br>Destructo Disk won't work on Beerus and the Picolo will have no effect on Freeza.</strong></p>";    
	return div;
  }
